...
// Agregação financeira mora no módulo compartilhado — report-routes e
// dashboard-routes importam a MESMA função (sem duplicar Decimal/NPS).
...
// buildFinanceiro (orçamentos + pagamentos + NPS) foi extraído para
// ../lib/reports/financeiro e é importado no topo — reusado aqui e no painel.
