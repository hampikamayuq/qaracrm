...
export default defineField({
  universalIdentifier: LEAD_CONVERSATIONS_FIELD_UNIVERSAL_IDENTIFIER,
  ...
  relationTargetFieldMetadataUniversalIdentifier: CONVERSATION_LEAD_FIELD_UNIVERSAL_IDENTIFIER,
  universalSettings: {
